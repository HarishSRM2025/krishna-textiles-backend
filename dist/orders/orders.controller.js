...
let OrdersController = class OrdersController {
    ...
    async findAll(status, search, customerId, page, limit) {
    ...
    async updateStatus(id, body) {
        const updated = await this.ordersService.updateStatus(id, body.status, body.trackingNumber, body.note, body.courierPartner, body.dispatchedAt, body.expectedDeliveryDate);
        return {
            success: true,
...
__decorate([
    (0, common_1.Get)(),
    (0, swagger_1.ApiOperation)({ summary: 'Get all orders with pagination and status filters' }),
...
__decorate([
    (0, common_1.Get)(':id'),
    (0, swagger_1.ApiOperation)({ summary: 'Get order details with line items' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Get printable GST tax invoice data for order' }),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
...
__decorate([
    (0, common_1.Post)(),
    (0, swagger_1.ApiOperation)({ summary: 'Create a new order (auto deducts stock & generates invoice)' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Update order status and manual fulfillment details' }),
    __param(0, (0, common_1.Param)('id')),
